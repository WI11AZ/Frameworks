...
class DCWFApp {
    ...
    async loadData() {
        try {
            ...
            const response = await fetch('https://ppl-ai-code-interpreter-files.s3.amazonaws.com/web/direct-files/fe4047c76860169dfdff75fb829f5190/7597d7e4-c2be-4665-b059-d4e87ce4a0fc/40abeaea.json');
