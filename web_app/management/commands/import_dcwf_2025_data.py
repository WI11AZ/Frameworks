        ...
        categories_data = [
            {
                ...
                'roles': [
                    ...
                    {'dcwf_code': '333', 'title': 'Partner Integration Planner', 'definition': 'Works to advance cooperation across organizational or national borders between cyber operations partners. Aids the integration of partner cyber teams by providing guidance, ressources, and collaboration to develop best practices and facilitate organizational support for achieving objectives in integrated cyber actions.'},
            ...
            },
            {
                ...
                'roles': [
                    {'dcwf_code': '111', 'title': 'All-Source Analyst', 'definition': 'Analyzes information from multiple sources to provide intelligence insights and support decision-making processes.'},
                    {'dcwf_code': '141', 'title': 'Threat Analyst', 'definition': 'Collects, processes, analyzes, and disseminates cybersecurity threat assessments. Develops cybersecurity indicators to maintain awareness of the status of the highly dynamic operating environment.'},
