          ...
          if (typeof type === "object") {
            switch (type.$$typeof) {
              ...
              case REACT_MEMO_TYPE:
                ...
                return getComponentNameFromType2(type.type) || "Memo";
              case REACT_LAZY_TYPE: {
                var lazyComponent = type;
                var payload = lazyComponent._payload;
                var init = lazyComponent._init;
                try {
                  return getComponentNameFromType2(init(payload));
                } catch (x) {
                  return null;
                }
              }
        ...
        function warnIfStringRefCannotBeAutoConverted(config, self) {
          {
            if (typeof config.ref === "string" && ReactCurrentOwner.current && self && ReactCurrentOwner.current.stateNode !== self) {
              var componentName = getComponentNameFromType2(ReactCurrentOwner.current.type);
              if (!didWarnAboutStringRefs[componentName]) {
                error('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', getComponentNameFromType2(ReactCurrentOwner.current.type), config.ref);
        ...
        function getDeclarationErrorAddendum() {
          {
            if (ReactCurrentOwner$1.current) {
              var name = getComponentNameFromType2(ReactCurrentOwner$1.current.type);
              if (name) {
        ...
        function validateExplicitKey(element, parentType) {
          {
            ...
            if (element && element._owner && element._owner !== ReactCurrentOwner$1.current) {
              childOwner = " It was passed a child from " + getComponentNameFromType2(element._owner.type) + ".";
            }
        ...
        function validatePropTypes(element) {
          {
            ...
            if (propTypes) {
              ...
              var _name = getComponentNameFromType2(type);
        ...
        function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
          {
            ...
            if (!validType) {
              ...
              if (type === null) {
                ...
                typeString = "<" + (getComponentNameFromType2(type.type) || "Unknown") + " />";
            ...
            }
            {
              if (hasOwnProperty.call(props, "key")) {
                var componentName = getComponentNameFromType2(type);
...
var IconHelp = ({ size = 20, ...props }) => (0, import_jsx_runtime.jsxs)("svg", { width: size, height: size, viewBox: "0 0 20 20", fill: "none", ...props, children: [
  (0, import_jsx_runtime.jsx)("circle", { cx: "10", cy: "10", r: "6", stroke: "currentColor", strokeWidth: "1.25" }),
  (0, import_jsx_runtime.jsx)("path", { d: "M8.24 8.19C8.38 7.78 8.66 7.44 9.03 7.23C9.4 7.01 9.84 6.93 10.26 7C10.68 7.07 11.06 7.29 11.34 7.62C11.61 7.95 11.76 8.36 11.76 8.79152C11.76 10 10 10.6 10 10.6V10.83", stroke: "currentColor", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" }),
  (0, import_jsx_runtime.jsx)("circle", { cx: "10", cy: "13", r: "0.625", fill: "currentColor" })
] });
...
var IconCopyAnimated = ({ size = 24, copied = false }) => (0, import_jsx_runtime.jsxs)("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", children: [
  (0, import_jsx_runtime.jsxs)("g", { className: `${icon_transitions_module_default.iconState} ${copied ? icon_transitions_module_default.hiddenScaled : icon_transitions_module_default.visibleScaled}`, children: [
    (0, import_jsx_runtime.jsx)(
      "path",
      {
        d: "M4.75 11.25C4.75 10.4216 5.42157 9.75 6.25 9.75H12.75C13.5784 9.75 14.25 10.4216 14.25 11.25V17.75C14.25 18.5784 13.5784 19.25 12.75 19.25H6.25C5.42157 19.25 4.75 18.5784 4.75 17.75V11.25Z",
  ...
  (0, import_jsx_runtime.jsxs)("g", { className: `${icon_transitions_module_default.iconState} ${copied ? icon_transitions_module_default.visibleScaled : icon_transitions_module_default.hiddenScaled}`, children: [
    (0, import_jsx_runtime.jsx)(
      "path",
      {
...
var IconSendArrow = ({
  ...
  return (0, import_jsx_runtime.jsxs)("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", children: [
    (0, import_jsx_runtime.jsx)("g", { className: `${icon_transitions_module_default.iconStateFast} ${showArrow ? icon_transitions_module_default.visibleScaled : isSending ? icon_transitions_module_default.sending : icon_transitions_module_default.hiddenScaled}`, children: (0, import_jsx_runtime.jsx)(
      "path",
      {
    ...
    (0, import_jsx_runtime.jsxs)("g", { className: `${icon_transitions_module_default.iconStateFast} ${showCheck ? icon_transitions_module_default.visibleScaled : icon_transitions_module_default.hiddenScaled}`, children: [
      (0, import_jsx_runtime.jsx)(
        "path",
        {
          d: "M12 20C7.58172 20 4 16.4182 4 12C4 7.58172 7.58172 4 12 4C16.4182 4 20 7.58172 20 12C20 16.4182 16.4182 20 12 20Z",
    ...
    (0, import_jsx_runtime.jsxs)("g", { className: `${icon_transitions_module_default.iconStateFast} ${showError ? icon_transitions_module_default.visibleScaled : icon_transitions_module_default.hiddenScaled}`, children: [
      (0, import_jsx_runtime.jsx)(
        "path",
        {
          d: "M12 20C7.58172 20 4 16.4182 4 12C4 7.58172 7.58172 4 12 4C16.4182 4 20 7.58172 20 12C20 16.4182 16.4182 20 12 20Z",
      ...
      (0, import_jsx_runtime.jsx)("circle", { cx: "12", cy: "15", r: "0.5", fill: "var(--agentation-color-red)", stroke: "var(--agentation-color-red)", strokeWidth: "1" })
    ] })
  ] });
};
...
function getReactDispatcher() {
  const reactModule = import_react3.default;
...
var Tooltip = ({
  ...
  const [position, setPosition] = (0, import_react4.useState)({ top: 0, right: 0 });
  const triggerRef = (0, import_react4.useRef)(null);
  const timeoutRef = (0, import_react4.useRef)(null);
  const exitTimeoutRef = (0, import_react4.useRef)(null);
...
var HelpTooltip = ({ content }) => {
  return (0, import_jsx_runtime4.jsx)(Tooltip, { className: styles_module_default3.tooltip, content, children: (0, import_jsx_runtime4.jsx)(IconHelp, { className: styles_module_default3.tooltipIcon }) });
};
...
function PageFeedbackToolbarCSS({
  ...
  const toggleTheme = () => {
    var _a2;
    (_a2 = portalWrapperRef.current) == null ? void 0 : _a2.classList.add(styles_module_default2.disableTransitions);
    setIsDarkMode((previous) => !previous);
    requestAnimationFrame(() => {
      var _a3;
      (_a3 = portalWrapperRef.current) == null ? void 0 : _a3.classList.remove(styles_module_default2.disableTransitions);
    });
  };
  ...
  return (0, import_react_dom.createPortal)(
    (0, import_jsx_runtime5.jsxs)("div", { ref: portalWrapperRef, style: { display: "contents" }, "data-agentation-theme": isDarkMode ? "dark" : "light", "data-agentation-accent": settings.annotationColorId, children: [
              ...
              children: [
                (0, import_jsx_runtime5.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      (0, import_jsx_runtime5.jsx)(IconListSparkle, { size: 24 }),
                      hasAnnotations && (0, import_jsx_runtime5.jsx)(
                        "span",
                        {
                          ...
                          children: [
                            (0, import_jsx_runtime5.jsx)(
                              "button",
                              {
                                ...
                                children: (0, import_jsx_runtime5.jsx)(IconPausePlayAnimated, { size: 24, isPaused: isFrozen })
                              }
                            ),
                            (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.buttonTooltip, children: [
                              isFrozen ? "Resume animations" : "Pause animations",
                              (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.shortcut, children: "P" })
                            ] })
                          ]
                        }
                      ),
                      (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.buttonWrapper, children: [
                        (0, import_jsx_runtime5.jsx)(
                          "button",
                          {
                            className: styles_module_default2.controlButton,
                            ...
                            children: (0, import_jsx_runtime5.jsx)(IconEyeAnimated, { size: 24, isOpen: showMarkers })
                          }
                        ),
                        (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.buttonTooltip, children: [
                          showMarkers ? "Hide markers" : "Show markers",
                          (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.shortcut, children: "H" })
                        ] })
                      ] }),
                      (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.buttonWrapper, children: [
                        (0, import_jsx_runtime5.jsx)(
                          "button",
                          {
                            ...
                            disabled: !hasAnnotations,
                            "data-active": copied,
                            children: (0, import_jsx_runtime5.jsx)(IconCopyAnimated, { size: 24, copied })
                          }
                        ),
                        (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.buttonTooltip, children: [
                          "Copy feedback",
                          (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.shortcut, children: "C" })
                        ] })
                      ] }),
                      (0, import_jsx_runtime5.jsxs)(
                        "div",
                          ...
                          children: [
                            (0, import_jsx_runtime5.jsxs)(
                              "button",
                              {
                                ...
                                children: [
                                  (0, import_jsx_runtime5.jsx)(IconSendArrow, { size: 24, state: sendState }),
                                  hasAnnotations && sendState === "idle" && (0, import_jsx_runtime5.jsx)(
                                    "span",
                                    {
                            ...
                            (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.buttonTooltip, children: [
                              "Send Annotations",
                              (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.shortcut, children: "S" })
                            ] })
                          ]
                        }
                      ),
                      (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.buttonWrapper, children: [
                        (0, import_jsx_runtime5.jsx)(
                          "button",
                          {
                            ...
                            disabled: !hasAnnotations,
                            "data-danger": true,
                            children: (0, import_jsx_runtime5.jsx)(IconTrashAlt, { size: 24 })
                          }
                        ),
                        (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.buttonTooltip, children: [
                          "Clear all",
                          (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.shortcut, children: "X" })
                        ] })
                      ] }),
                      (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.buttonWrapper, children: [
                        (0, import_jsx_runtime5.jsx)(
                          "button",
                          {
                            ...
                            children: (0, import_jsx_runtime5.jsx)(IconGear, { size: 24 })
                          }
                        ),
                        endpoint && connectionStatus !== "disconnected" && (0, import_jsx_runtime5.jsx)(
                          "span",
                          {
                        ...
                        (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.buttonTooltip, children: "Settings" })
                      ] }),
                      (0, import_jsx_runtime5.jsx)(
                        "div",
                        {
                          ...
                          children: [
                            (0, import_jsx_runtime5.jsx)(
                              "button",
                              {
                                ...
                                children: (0, import_jsx_runtime5.jsx)(IconXmarkLarge, { size: 24 })
                              }
                            ),
                            (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.buttonTooltip, children: [
                              "Exit",
                              (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.shortcut, children: "Esc" })
                            ] })
                          ]
                        }
                      )
                        ...
                        children: [
                          (0, import_jsx_runtime5.jsxs)(
                            "div",
                            {
                              ...
                              children: [
                                (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.settingsHeader, children: [
                                  (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.settingsBrand, children: [
                                    (0, import_jsx_runtime5.jsx)(
                                      "span",
                                      {
                                  ...
                                  (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.settingsVersion, children: [
                                    "v",
                                    "2.3.3"
                                  ] }),
                                  (0, import_jsx_runtime5.jsx)(
                                    "button",
                                    {
                                      ...
                                      children: (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.themeIconWrapper, children: (0, import_jsx_runtime5.jsx)(
                                        "span",
                                        {
                                          className: styles_module_default2.themeIcon,
                                          children: isDarkMode ? (0, import_jsx_runtime5.jsx)(IconSun, { size: 20 }) : (0, import_jsx_runtime5.jsx)(IconMoon, { size: 20 })
                                        },
                                        isDarkMode ? "sun" : "moon"
                                      ) })
                                    }
                                ...
                                (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.settingsSection, children: [
                                  (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.settingsRow, children: [
                                    (0, import_jsx_runtime5.jsxs)(
                                      "div",
                                      {
                                        ...
                                        children: [
                                          "Output Detail",
                                          (0, import_jsx_runtime5.jsx)(HelpTooltip, { content: "Controls how much detail is included in the copied output" })
                                        ]
                                      }
                                    ),
                                    (0, import_jsx_runtime5.jsxs)(
                                      "button",
                                      {
                                        ...
                                        children: [
                                          ...
                                          (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.cycleDots, children: OUTPUT_DETAIL_OPTIONS.map((option, i) => (0, import_jsx_runtime5.jsx)(
                                            "span",
                                            {
                                        ...
                                        (0, import_jsx_runtime5.jsxs)(
                                          "label",
                                          {
                                            ...
                                            children: [
                                              ...
                                              (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.toggleSlider })
                                            ]
                                          }
                                        )
                                      ]
                                  ...
                                  (0, import_jsx_runtime5.jsxs)("div", { className: `${styles_module_default2.settingsRow} ${styles_module_default2.settingsRowMarginTop}`, children: [
                                    (0, import_jsx_runtime5.jsxs)(
                                      "div",
                                      {
                                        className: styles_module_default2.settingsLabel,
                                        children: [
                                          "Hide Until Restart",
                                          (0, import_jsx_runtime5.jsx)(HelpTooltip, { content: "Hides the toolbar until you open a new tab" })
                                        ]
                                      }
                                    ),
                                    (0, import_jsx_runtime5.jsxs)("label", { className: styles_module_default2.toggleSwitch, children: [
                                      (0, import_jsx_runtime5.jsx)(
                                        "input",
                                        {
                                          type: "checkbox",
                                ...
                                (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.settingsSection, children: [
                                  ...
                                  (0, import_jsx_runtime5.jsx)("div", { className: styles_module_default2.colorOptions, children: COLOR_OPTIONS.map((color) => (0, import_jsx_runtime5.jsx)(
                                    "div",
                                    {
                                      role: "button",
                                ...
                                (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.settingsSection, children: [
                                  (0, import_jsx_runtime5.jsxs)("label", { className: styles_module_default2.settingsToggle, children: [
                                    (0, import_jsx_runtime5.jsx)(
                                      "input",
                                      {
                                        type: "checkbox",
                                    ...
                                    (0, import_jsx_runtime5.jsx)(
                                      "label",
                                      {
                                        ...
                                        children: settings.autoClearAfterCopy && (0, import_jsx_runtime5.jsx)(IconCheckSmallAnimated, { size: 14 })
                                      }
                                    ),
                                    (0, import_jsx_runtime5.jsxs)(
                                      "span",
                                      {
                                        ...
                                        children: [
                                          "Clear on copy/send",
                                          (0, import_jsx_runtime5.jsx)(HelpTooltip, { content: "Automatically clear annotations after copying" })
                                        ]
                                      }
                                    )
                                  ] }),
                                      ...
                                      children: [
                                        ...
                                        (0, import_jsx_runtime5.jsx)(
                                          "label",
                                          {
                                            ...
                                            children: settings.blockInteractions && (0, import_jsx_runtime5.jsx)(IconCheckSmallAnimated, { size: 14 })
                                          }
                                        ),
                                        (0, import_jsx_runtime5.jsx)(
                                          "span",
                                  ...
                                  "div",
                                  {
                                    ...
                                    children: (0, import_jsx_runtime5.jsxs)(
                                      "button",
                                      {
                                        ...
                                        children: [
                                          (0, import_jsx_runtime5.jsx)("span", { children: "Manage MCP & Webhooks" }),
                                          (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.settingsNavLinkRight, children: [
                                            endpoint && connectionStatus !== "disconnected" && (0, import_jsx_runtime5.jsx)(
                                              "span",
                                              {
                                            ...
                                            (0, import_jsx_runtime5.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, import_jsx_runtime5.jsx)("path", { d: "M7.5 12.5L12 8L7.5 3.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })
                                          ] })
                                        ]
                                      }
                                    )
                              ...
                              children: [
                                (0, import_jsx_runtime5.jsxs)(
                                  "button",
                                  {
                                    ...
                                    children: [
                                      (0, import_jsx_runtime5.jsx)(IconChevronLeft, { size: 16 }),
                                      (0, import_jsx_runtime5.jsx)("span", { children: "Manage MCP & Webhooks" })
                                    ]
                                  }
                                ),
                                  ...
                                  (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.settingsRow, children: [
                                    (0, import_jsx_runtime5.jsxs)(
                                      "span",
                                      {
                                        ...
                                        children: [
                                          "MCP Connection",
                                          (0, import_jsx_runtime5.jsx)(HelpTooltip, { content: "Connect via Model Context Protocol to let AI agents like Claude Code receive annotations in real-time." })
                                        ]
                                      }
                                    ),
                                    endpoint && (0, import_jsx_runtime5.jsx)(
                                      "div",
                                      {
                                      ...
                                      (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.settingsRow, children: [
                                        (0, import_jsx_runtime5.jsxs)(
                                          "span",
                                          {
                                            ...
                                            children: [
                                              "Webhooks",
                                              (0, import_jsx_runtime5.jsx)(HelpTooltip, { content: "Send annotation data to any URL endpoint when annotations change. Useful for custom integrations." })
                                            ]
                                          }
                                        ),
                                        (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.autoSendRow, children: [
                                          (0, import_jsx_runtime5.jsx)(
                                            "span",
                                            {
      ...
      (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.markersLayer, "data-feedback-toolbar": true, children: [
        markersVisible && visibleAnnotations.filter((a) => !a.isFixed).map((annotation, index) => {
          ...
          return (0, import_jsx_runtime5.jsxs)(
            "div",
            {
              ...
              children: [
                showDeleteState ? showDeleteHover ? (0, import_jsx_runtime5.jsx)(IconXmark, { size: isMulti ? 18 : 16 }) : (0, import_jsx_runtime5.jsx)(IconEdit, { size: 16 }) : (0, import_jsx_runtime5.jsx)(
                  "span",
                  {
                ...
                isHovered && !editingAnnotation && (0, import_jsx_runtime5.jsxs)(
                  "div",
                  {
                    className: `${styles_module_default2.markerTooltip} ${styles_module_default2.enter}`,
                    style: getTooltipPosition(annotation),
                    children: [
                      (0, import_jsx_runtime5.jsxs)("span", { className: styles_module_default2.markerQuote, children: [
                        annotation.element,
                        annotation.selectedText && ` "${annotation.selectedText.slice(0, 30)}${annotation.selectedText.length > 30 ? "..." : ""}"`
                      ] }),
                      (0, import_jsx_runtime5.jsx)("span", { className: styles_module_default2.markerNote, children: annotation.comment })
                    ]
                  }
                )
              ]
        ...
        markersVisible && !markersExiting && exitingAnnotationsList.filter((a) => !a.isFixed).map((annotation) => {
          ...
          return (0, import_jsx_runtime5.jsx)(
            "div",
            {
              ...
              children: (0, import_jsx_runtime5.jsx)(IconXmark, { size: isMulti ? 12 : 10 })
            },
            annotation.id
          );
        })
      ] }),
      (0, import_jsx_runtime5.jsxs)("div", { className: styles_module_default2.fixedMarkersLayer, "data-feedback-toolbar": true, children: [
        markersVisible && visibleAnnotations.filter((a) => a.isFixed).map((annotation, index) => {
        ...
        markersVisible && !markersExiting && exitingAnnotationsList.filter((a) => a.isFixed).map((annotation) => {
          ...
          return (0, import_jsx_runtime5.jsx)(
            "div",
            {
              ...
              children: (0, import_jsx_runtime5.jsx)(IconClose, { size: isMulti ? 12 : 10 })
            },
            annotation.id
          );
        })
      ] }),
      isActive && (0, import_jsx_runtime5.jsxs)(
        "div",
        {
          ...
          children: [
            (hoverInfo == null ? void 0 : hoverInfo.rect) && !pendingAnnotation && !isScrolling && !isDragging && (0, import_jsx_runtime5.jsx)(
              "div",
              {
            ...
            hoveredMarkerId && !pendingAnnotation && (() => {
              ...
              if ((_a2 = hoveredAnnotation.elementBoundingBoxes) == null ? void 0 : _a2.length) {
                ...
                return hoveredAnnotation.elementBoundingBoxes.map(
                  (bb2, index) => (0, import_jsx_runtime5.jsx)(
                    "div",
                    {
                      className: `${styles_module_default2.multiSelectOutline} ${styles_module_default2.enter}`,
                      style: {
            ...
            hoverInfo && !pendingAnnotation && !isScrolling && !isDragging && (0, import_jsx_runtime5.jsxs)(
              "div",
              {
                ...
                children: [
                  hoverInfo.reactComponents && (0, import_jsx_runtime5.jsx)("div", { className: styles_module_default2.hoverReactPath, children: hoverInfo.reactComponents }),
                  (0, import_jsx_runtime5.jsx)("div", { className: styles_module_default2.hoverElementName, children: hoverInfo.elementName })
                ]
              }
            ),
            pendingAnnotation && (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
              ((_b = pendingAnnotation.multiSelectElements) == null ? void 0 : _b.length) ? (
                ...
                pendingAnnotation.targetElement && document.contains(pendingAnnotation.targetElement) ? (
                  ...
                  pendingAnnotation.boundingBox && (0, import_jsx_runtime5.jsx)(
                    "div",
                    {
                ...
                return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
                  (0, import_jsx_runtime5.jsx)(
                    "div",
                    {
                      ...
                      children: (0, import_jsx_runtime5.jsx)(IconPlus, { size: 12 })
                    }
                  ),
                  (0, import_jsx_runtime5.jsx)(
                    AnnotationPopupCSS,
            ...
            editingAnnotation && (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
              ((_c = editingAnnotation.elementBoundingBoxes) == null ? void 0 : _c.length) ? (
                ...
                (() => {
                  ...
                  return editingAnnotation.elementBoundingBoxes.map(
                    (bb, index) => (0, import_jsx_runtime5.jsx)(
                      "div",
                      {
                        className: `${styles_module_default2.multiSelectOutline} ${styles_module_default2.enter}`,
                        style: {
            ...
            isDragging && (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
              (0, import_jsx_runtime5.jsx)("div", { ref: dragRectRef, className: styles_module_default2.dragSelection }),
              (0, import_jsx_runtime5.jsx)(
                "div",
                {
